...
//render all the light processed
...
// render a png with given specifications
// \param *renderer the current renderer to present in
// \param *texture the texture to render
// \param pos_x the x position considering the top left corner
// \param pos_y the y position considering the top left corner
