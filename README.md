...
gcc src/main.c src/tools.c src/debug.c src/draw/draw.c src/draw/menu.c src/level/level.c src/level/highlight.c src/level/light.c src/level/objects/player.c src/level/objects/item.c -o game && game.exe
