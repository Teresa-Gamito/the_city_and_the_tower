...
void levelSetItems(char * level_to_draw, Torch item); // there should be a better way of doing this
void levelSetItems(char * level_to_draw, Plank item);
void levelSetItems(char * level_to_draw, Relic item);
